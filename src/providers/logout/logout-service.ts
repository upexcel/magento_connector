...
export class LogoutService {
    constructor(public _logout:LOGOUT,public _eventService: EventService,private _cartFunction: CartFunction, private _dataConfigService: AppDataConfigService, private _local: Storage) {}
    logout(msg, _navCtrl?) {
        this._logout.getLogout().then((res)=>{console.log(res);});
